export default function Footer() {
    return (
        <footer className="text-black bg-white mt-8 py-4">
            <div className="max-w-screen-md mx-auto px-4 gap-2 flex flex-col items-center justify-center">
                <div className="container mx-auto text-center flex justify-center">
                    <a target="_blank" href="https://github.com/woosuk1028">
                ...
                <div className="container mx-auto text-center">
                    <p>&copy; {new Date().getFullYear()} Woo Seok. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
